...
namespace Luthetus.Ide.RazorLib.DotNetOutputs.Displays;

public partial class DotNetOutputDisplay : ComponentBase
{
	[Parameter, EditorRequired]
	public List<IOutputLine> OutputLineList { get; set; } = null!;
	
	private readonly OutputDecorationMapper _decorationMapper = new();
