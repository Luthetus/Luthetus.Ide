...
public class PartitionedRichCharacterListTests
{
    ...
    #region RowEndingList
    [Fact]
    public void Add_RowEnding_One_Partitions_Start()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        ...
        Assert.Single(partitionRichCharacterMetadata.RowEndingList);
        var rowEndingPosition = partitionRichCharacterMetadata.RowEndingList.Single();
        Assert.Equal(0, rowEndingPosition.StartPositionIndexInclusive);
    }

    [Fact]
    public void Add_RowEnding_One_Partitions_Middle()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
    ...
    [Fact]
    public void Add_RowEnding_One_Partitions_End()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
    ...
    [Fact]
    public void Add_Four_RowEndings()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
    ...
    [Fact]
    public void Insert_RowEnding_One_Partitions_Start()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        var richCharacterList = "\nab".Select(x => new RichCharacter { Value = x }).ToArray();
        partitionedRichCharacterList = partitionedRichCharacterList.InsertRange(0, richCharacterList);
    ...
    [Fact]
    public void Insert_RowEnding_One_Partitions_Middle()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        var richCharacterList = "a\nb".Select(x => new RichCharacter { Value = x }).ToArray();
        partitionedRichCharacterList = partitionedRichCharacterList.InsertRange(0, richCharacterList);
    ...
    [Fact]
    public void Insert_RowEnding_One_Partitions_End()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        var richCharacterList = "ab\n".Select(x => new RichCharacter { Value = x }).ToArray();
        partitionedRichCharacterList = partitionedRichCharacterList.InsertRange(0, richCharacterList);
    ...
    [Fact]
    public void Insert_RowEnding_One_Partitions_Expansion()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        var richCharacterList = "ab\n".Select(x => new RichCharacter { Value = x }).ToArray();
        partitionedRichCharacterList = partitionedRichCharacterList.InsertRange(0, richCharacterList);
    ...
    [Fact]
    public void Insert_Four_RowEndings()
    {
        var partitionedRichCharacterList = new PartitionedRichCharacterList(3);
        var richCharacterList = new string('\n', 4).Select(x => new RichCharacter { Value = x }).ToArray();
        partitionedRichCharacterList = partitionedRichCharacterList.InsertRange(0, richCharacterList);
