...
public class TextManipulationTests : TextEditorTestingBase
{
    [Fact]
    public void INSERT_CHARACTER_BY_KEYBOARD_EVENT()
    {
        ...
        TextEditorHelper.TextEditorService.Model.HandleKeyboardEvent(keyboardEventAction);
    ...
    public void DELETE_SINGLE_CHARACTER()
    {
        ...
        TextEditorHelper.TextEditorService.Model.InsertText(
        ...
        TextEditorHelper.TextEditorService.Model.DeleteTextByRange(
