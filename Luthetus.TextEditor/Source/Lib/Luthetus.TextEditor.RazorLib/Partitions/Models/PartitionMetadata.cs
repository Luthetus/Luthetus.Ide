...
{
    public int RelativeCharacterCount { get; init; }
	public ImmutableList<int> TabList { get; init; } = ImmutableList<int>.Empty; // ITextEditorModel.TabKeyPositionsList
	public ImmutableList<RowEnding> RowEndingList { get; init; } = ImmutableList<RowEnding>.Empty; // ITextEditorModel.RowEndingPositionsList
    public ImmutableList<(RowEndingKind rowEndingKind, int count)> RowEndingKindCountList { get; init; } = ImmutableList<(RowEndingKind rowEndingKind, int count)>.Empty; // ITextEditorModel.RowEndingKindCountsList
    public RowEndingKind? OnlyRowEndingKind { get; init; } // ITextEditorModel.OnlyRowEndingKind
}
