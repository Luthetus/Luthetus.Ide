...
public class LuthLexer : ILuthLexer
{
    ...
    protected readonly List<ISyntaxToken> _syntaxTokens = new();
    ...
    protected virtual void LexNumericLiteralToken()
    {
    ...
    protected virtual void LexStringLiteralToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCommentSingleLineToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCommentMultiLineToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexIdentifierOrKeywordOrKeywordContextual()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexPlusToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexPlusPlusToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexMinusToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexMinusMinusToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexEqualsToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexEqualsEqualsToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexQuestionMarkToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexQuestionMarkQuestionMarkToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexStarToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexDivisionToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexBangToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexStatementDelimiterToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexOpenParenthesisToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCloseParenthesisToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexOpenBraceToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCloseBraceToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexOpenAngleBracketToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCloseAngleBracketToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexOpenSquareBracketToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCloseSquareBracketToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexDollarSignToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexColonToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexMemberAccessToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexCommaToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual void LexPreprocessorDirectiveToken()
    {
        var entryPositionIndex = _stringWalker.PositionIndex;
    ...
    protected virtual SyntaxKind GetSyntaxKindForKeyword(TextEditorTextSpan textSpan)
    {
    ...
    protected virtual SyntaxKind GetSyntaxKindForContextualKeyword(TextEditorTextSpan textSpan)
    {
        var text = textSpan.GetText();
