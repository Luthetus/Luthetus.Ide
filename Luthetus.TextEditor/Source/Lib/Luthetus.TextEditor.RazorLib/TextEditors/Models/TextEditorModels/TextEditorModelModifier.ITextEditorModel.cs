...
{
	public PartitionContainer ContentList => _contentList;
	...
	public RowEndingKind UsingRowEndingKind => _usingRowEndingKind;
	public ResourceUri ResourceUri => _resourceUri ?? _textEditorModel.ResourceUri;
	public DateTime ResourceLastWriteTime => _resourceLastWriteTime;
	...
	public int EditBlockIndex => _editBlockIndex;
	public (int rowIndex, int rowLength) MostCharactersOnASingleRowTuple => _mostCharactersOnASingleRowTuple;
	public Key<RenderState> RenderStateKey => _renderStateKey;
