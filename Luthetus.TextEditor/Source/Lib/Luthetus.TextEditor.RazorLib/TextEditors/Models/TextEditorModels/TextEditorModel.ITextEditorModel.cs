...
public partial class TextEditorModel : ITextEditorModel
{
	...
	ImmutableList<RowEnding> ITextEditorModel.RowEndingPositionsList => RowEndingPositionsList;
    ImmutableList<(RowEndingKind rowEndingKind, int count)> ITextEditorModel.RowEndingKindCountsList => RowEndingKindCountsList;
