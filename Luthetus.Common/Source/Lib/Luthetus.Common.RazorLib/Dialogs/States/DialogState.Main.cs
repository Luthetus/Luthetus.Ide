...
public partial record DialogState
{
    public DialogState()
    {
        DialogList = ImmutableList<IPolymorphicDialog>.Empty;
    }

    public ImmutableList<IPolymorphicDialog> DialogList { get; init; }
    /// <summary>
    ...
    /// </summary>
    public Key<IPolymorphicUiRecord> ActiveDialogKey { get; init; }
}