...
{
    /// <summary>
    /// <see cref="TreeViewFields(WatchWindowObject, bool, bool, RazorLib.ComponentRenderers.Models.ILuthetusCommonComponentRenderers)"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="TreeViewFields.LoadChildBagAsync()"/>
    /// </summary>
    [Fact]
