    ...
    protected override void QueueParseRequest(ResourceUri resourceUri)
    {
        _textEditorService.Post(
            ...
            async editContext =>
            {
                ...
                var lexer = new CLexer(modelModifier.ResourceUri);
                ...
                lock (_resourceMapLock)
                {
                    ...
                    var fSharpResource = (CResource)_resourceMap[resourceUri];
                    fSharpResource.TokenTextSpanList = lexResult;
                }
