...
/// <summary>
/// <see cref="MenuOptionsFactory"/>
/// </summary>
public class MenuOptionsFactoryTests
{
    /// <summary>
    /// <see cref="MenuOptionsFactory(ILuthetusIdeComponentRenderers, ILuthetusCommonComponentRenderers, IFileSystemProvider, IEnvironmentProvider, IClipboardService, IBackgroundTaskService)"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.NewEmptyFile(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.NewTemplatedFile(NamespacePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.NewDirectory(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.DeleteFile(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.RenameFile(IAbsolutePath, IDispatcher, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.CopyFile(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.CutFile(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    public void CutFile()
    {
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.PasteClipboard(IAbsolutePath, Func{Task})"/>
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// <see cref="MenuOptionsFactory.CopyFilesRecursively(DirectoryInfo, DirectoryInfo)"/>
    /// </summary>
    [Fact]
