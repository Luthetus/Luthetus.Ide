...
{
    /// <summary>
    /// This file took so long that I gave up and stopped the test. (it'd been a few minutes I think)
    /// I'm going to make another constant that has about 1/3 of this text. (2024-03-01)
    /// 
    /// 20 ms under the same conditions after I re-wrote the insert range method. (2024-03-01)
    /// </summary>
    public const string LARGE_FILE = @"using Fluxor;
...
public partial class TextEditorViewModelDisplay : ComponentBase, IDisposable
{
    ...
    /// <summary>
    /// 11.3 seconds to construct a TextEditorModel with null compiler service and null decoration mapper. (2024-03-01)
    /// 
    /// 20 ms under the same conditions after I re-wrote the insert range method. (2024-03-01)
    /// </summary>
    public const string LESS_LARGE_FILE = @"using Fluxor;
using Microsoft.AspNetCore.Components;
using Luthetus.TextEditor.RazorLib.Installations.Models;
using Luthetus.TextEditor.RazorLib.Keymaps.Models;
using Luthetus.TextEditor.RazorLib.TextEditors.Displays.Internals;
