...
public partial class TextEditorModelModifierTests
{
    ...
    [Fact]
    public void Delete_Causes_DecreaseCounters()
    {
        // Create test data
        TextEditorModel inModel;
        TextEditorModelModifier modelModifier;
        {
            inModel = new TextEditorModel(
                new ResourceUri($"/{nameof(Delete_Causes_DecreaseCounters)}.txt"),
                DateTime.UtcNow,
                ExtensionNoPeriodFacts.TXT,
                (
                    "\n" +   // LineFeed
    ...
    [Fact]
    public void Delete_Causes_MaintainCounters()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_Causes_IncreaseCounters()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_EmptyEditor_At_PositionIndex_EqualTo_Exclusive_LowerBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_EmptyEditor_At_PositionIndex_EqualTo_Inclusive_LowerBound()
    {
        throw new NotImplementedException();
    }
    
    [Fact]
    public void Delete_From_EmptyEditor_At_PositionIndex_Between_0_And_DocumentLength_Exclusive()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_EmptyEditor_At_PositionIndex_EqualTo_Inclusive_UpperBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_EmptyEditor_At_PositionIndex_EqualTo_Exclusive_UpperBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_NotEmptyEditor_At_PositionIndex_EqualTo_Exclusive_LowerBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_NotEmptyEditor_At_PositionIndex_EqualTo_Inclusive_LowerBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_NotEmptyEditor_At_PositionIndex_Between_0_And_DocumentLength_Exclusive()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_NotEmptyEditor_At_PositionIndex_EqualTo_Inclusive_UpperBound()
    {
        throw new NotImplementedException();
    }

    [Fact]
    public void Delete_From_NotEmptyEditor_At_PositionIndex_EqualTo_Exclusive_UpperBound()
    {
        throw new NotImplementedException();
    }
    #endregion
