...
public class TreeViewSemanticModel : TreeViewWithType<ISemanticModel>
{
    public TreeViewSemanticModel(
    ...
    public override TreeViewRenderer GetTreeViewRenderer()
    {
        return new TreeViewRenderer(
            typeof(TreeViewSemanticModelDisplay),
            new Dictionary<string, object?>
            {
                {
                    nameof(TreeViewSemanticModelDisplay.SemanticModel),
                    Item
                },
            });
    }
    ...
    public override async Task LoadChildrenAsync()
    {
        ...
        try
        {
            var watchWindowObjectWrap = new WatchWindowObjectWrap(
                Item,
                typeof(ISemanticModel),
                "ISemanticModel",
                true);

            var reflectionNode = new TreeViewReflection(
