...
public sealed record DotNetSolutionSemanticContext : ISemanticContext
{
    public DotNetSolutionSemanticContext(
        ...
        ImmutableDictionary<DotNetProjectKey, DotNetProjectSemanticContext> dotNetProjectContextMap)
    {
        Key = key;
        DotNetSolution = dotNetSolution;
        DotNetProjectContextMap = dotNetProjectContextMap;
    ...
    public ImmutableDictionary<DotNetProjectKey, DotNetProjectSemanticContext> DotNetProjectContextMap { get; init; }
}
