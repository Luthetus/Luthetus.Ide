...
public sealed class FSharpCompilerService : ICompilerService
{
    ...
    public void RegisterResource(ResourceUri resourceUri, bool shouldTriggerResourceWasModified)
    {
    	lock (_resourceMapLock)
        {
            ...
            _resourceMap.Add(resourceUri, new FSharpResource(resourceUri, this));
        }
    ...
    {
    	var lexer = new TextEditorFSharpLexer(modelModifier.PersistentState.ResourceUri, modelModifier.GetAllText());
    	lexer.Lex();
