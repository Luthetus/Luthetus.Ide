...
public partial class TextEditorDefaultHeaderDisplay : ComponentBase, ITextEditorDependentComponent
{
    ...
    {
    	var renderBatchLocal = TextEditorViewModelDisplay._activeRenderBatch;
    ...
    public async Task DoReloadOnClick(MouseEventArgs arg)
    {
		...
		var absolutePath = EnvironmentProvider.AbsolutePathFactory(renderBatchLocal.Model.ResourceUri.Value, false);
		    ...
		    onClickFunc: () =>
		    {
			    TextEditorService.WorkerArbitrary.PostUnique(
		            ...
		            editContext =>
		            {
		            	...
		            	DirtyResourceUriService.RemoveDirtyResourceUri(renderBatchLocal.Model.ResourceUri);
