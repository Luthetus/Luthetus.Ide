...
public sealed class TextEditorViewModel : IDisposable
{
    ...
    public TextEditorCursor PrimaryCursor;
    /// <summary>
    ...
    /// </summary>
    public DisplayTracker DisplayTracker;
    /// <summary>
    ...
    /// </summary>
    public VirtualizationGrid VirtualizationResult;
	public TextEditorDimensions TextEditorDimensions;
	public ScrollbarDimensions ScrollbarDimensions;
	/// <summary>
	...
	/// </summary>
    public TooltipViewModel? TooltipViewModel;
    /// <summary>
    ...
    /// </summary>
    public bool ShowFindOverlay;
    public bool ShowReplaceButtonInFindOverlay;
    /// <summary>
    /// If one hits the keymap { Ctrl + s } when browser focus is within a text editor.
    /// </summary>
    public Action<TextEditorModel>? OnSaveRequested;
    /// <summary>
    ...
    /// </summary>
    public Func<TextEditorModel, string>? GetTabDisplayNameFunc;
    /// <summary>
    ...
    /// </summary>
    public List<Key<TextEditorPresentationModel>> FirstPresentationLayerKeysList;
    /// <summary>
    ...
    /// </summary>
    public List<Key<TextEditorPresentationModel>> LastPresentationLayerKeysList;
    /// <summary>
    /// The command bar is referring to the <see cref="Keymaps.Models.Vims.TextEditorKeymapVim"/>.
    ...
    /// </summary>
    public bool FindOverlayValueExternallyChangedMarker;
    public string ReplaceValueInFindOverlay;
	/// <summary>
    ...
    /// </summary>
    public bool ShouldSetFocusAfterNextRender;
    public bool ShouldRevealCursor;
    /// <summary>
    /// Relates to whether the cursor is within the viewable area of the Text Editor on the UI
    /// </summary>
    public bool CursorIsIntersecting;
    /// <summary>
    ...
    /// </summary>
    public DynamicViewModelAdapterTextEditor DynamicViewModelAdapter;
    public List<CollapsePoint> AllCollapsePointList = new();
    /// <summary>
    /// TODO: This does not belong here move this to the 'TextEditorViewModelSlimDisplay.razor'.
    /// </summary>
    public List<CollapsePoint> VirtualizedCollapsePointList = new();
    public bool HiddenLineIndexHashSetIsShallowCopy;
    public HashSet<int> HiddenLineIndexHashSet = new();
    /// <summary>
    ...
    /// </summary>
    public List<(InlineUi InlineUi, string Tag)> InlineUiList = new(); // { (new InlineUi(10, InlineUiKind.ThreeDotsExpandInlineUiThing), "aaa") };
    public VirtualAssociativityKind VirtualAssociativityKind = VirtualAssociativityKind.None;
    public bool CreateCacheWasInvoked;
    
    public bool ScrollWasModified;
	/// <summary>
    ...
    public string PrimaryCursorContentId;
    public string GutterElementId;
    public string FindOverlayId;
