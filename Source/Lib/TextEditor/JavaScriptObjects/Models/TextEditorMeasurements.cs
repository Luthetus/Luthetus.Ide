...
///              |
///              Furthermore, given the current way, everytime the <see cref="Virtualizations.Models.VirtualizationResult{T}"/> is calculated,
///              an invocation to JavaScript is made, in order to measure the HTML element which encompasses the
///              text editor.
///              |
